...
tags:
  ...
  - to-be-proposal
aliases:
  - "ServiceNowモダン開発環境 To-Be提案 インデックス"
related:
...
| [[07-raci-kpi-and-references|07-raci-kpi-and-references.md]] | RACI、KPI、最初に決めるべき事項、リポジトリ内／外部Webの設計根拠 |
| [[visual-overview.html]] | ブラウザだけで閲覧できる、提案全体のビジュアルHTML版 |
